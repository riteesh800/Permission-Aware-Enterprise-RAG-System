...
def seed(db: Session) -> None:
    ...
    engineering = Department(name="Engineering", description="Product engineering")
    finance = Department(name="Finance", description="Finance")
    hr = Department(name="HR", description="Human resources")
    exec_dept = Department(name="Executive", description="Leadership")
    db.add_all([engineering, finance, hr, exec_dept])
    db.flush()

    role_engineer = Role(name="engineer", description="Engineering staff")
    role_finance = Role(name="finance", description="Finance staff")
    role_hr = Role(name="hr", description="HR staff")
    role_manager = Role(name="manager", description="Department manager")
    role_exec = Role(name="executive", description="Executive")
    db.add_all([role_engineer, role_finance, role_hr, role_manager, role_exec])
    db.flush()

    group_eng = Group(name="engineering-team")
    group_fin = Group(name="finance-team")
    group_hr = Group(name="hr-team")
    group_mgr = Group(name="managers")
